        ...
        <div class="card">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="collapse"
                        data-bs-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample1">Как
                    купить?
                </button>
                <button type="button" class="btn btn-primary" data-bs-toggle="collapse"
                        data-bs-target="#collapseExample2" aria-expanded="false" aria-controls="collapseExample2">Как
                    доставить?
                </button>
                <button type="button" class="btn btn-primary" data-bs-toggle="collapse"
                        data-bs-target="#collapseExample3" aria-expanded="false" aria-controls="collapseExample3">Какая
                    гарантия?
                </button>
                <div class="collapse" id="collapseExample1">
                    <div class="card card-body">
                        Да как как! каком кверху!
                    </div>
                </div>

                <div class="collapse" id="collapseExample2">
                    <div class="card card-body">
                        На оленях или на собаках, ага
                    </div>
                </div>
